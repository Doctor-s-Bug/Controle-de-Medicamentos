...
IRepositorio<Medicamento> repositorioMedicamento = new RepositorioMedicamento(contexto);

IRepositorio<Funcionario> repositorioFuncionarios = new RepositorioFuncionario(contexto);
